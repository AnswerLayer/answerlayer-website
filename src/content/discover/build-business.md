...
externalUrl: null
---
The vision: every organization should have a semantic layer. Today, only the most sophisticated data teams can afford the investment. AnswerLayer makes semantic layers accessible to any organization with a database.
