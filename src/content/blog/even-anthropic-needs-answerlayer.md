...
<figure style="margin: 2.25rem 0;">
<svg viewBox="0 0 640 240" width="100%" role="img" aria-label="Two panels. Left: a skill, where a terminal invokes the warehouse and the session ends with context gone. Right: an application deployed inside the customer's AWS account, where AnswerLayer sits next to the warehouse and carries persistent capabilities: embed, evals, observe, ML and API.">
...
<text x="480" y="48" text-anchor="middle" style="font-family: var(--font-mono, monospace); font-size: 10px; fill: var(--color-navy-500, #4a57b4);">your cloud (AWS)</text>
